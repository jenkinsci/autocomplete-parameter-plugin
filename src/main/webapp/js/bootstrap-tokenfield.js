 ...
 * 
 * This version has been slightly changed to fit jenkins parameter inputs.
 */
...
(function (factory) {
  ...
  * ============================== */
  ...
  var Tokenfield = function (element, options) {
    ...
    this.$input = $('<input type="'+this.options.inputType+'" autocomplete="off" />')
                    .appendTo( this.$wrapper )
                    .prop( 'placeholder',  this.$element.prop('placeholder') )
                    .prop( 'id', id + '-tokenfield' )
                    .prop( 'tabindex', this.$element.data('original-tabindex') )
                    
    this.$input.addClass('token-input');
